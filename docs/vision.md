...
> This document captures the original vision, core goals, non-goals, roadmap, and requirements
> for Amris. It was previously the top-level `README.md`. As of v1.0 the README is a
> consumer-first quick-start; this longer-form background lives here for contributors and
> anyone interested in the library's design intent and history.
