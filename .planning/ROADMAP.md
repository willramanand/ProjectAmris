...
- [ ] 10-04-PLAN.md — combined COMPAT-02/03 rollout batch A1, 6 files, own test files (COMPAT-02, COMPAT-03, wave 2)
- [ ] 10-05-PLAN.md — combined COMPAT-02/03 rollout batch A2, 5 files, own test files (COMPAT-02, COMPAT-03, wave 2)
- [ ] 10-06-PLAN.md — combined COMPAT-02/03 rollout batch B, 4 files, own test files (COMPAT-02, COMPAT-03, wave 2)
...
| 10. Graceful Degradation & Compatibility Matrix | 3/8 | In Progress|  |
